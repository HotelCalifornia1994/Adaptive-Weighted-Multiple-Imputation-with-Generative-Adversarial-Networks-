...
def multiple(first_imputation_data, ori_data, ori_missing_data, ori_data_m):
    gain_parameters_1 = {'batch_size': 64,
                         'hint_rate': 0.9,
                         'alpha': 100,
                         'iterations': 10000,
                         'learning_rate': 0.001}
    gain_parameters_2 = {'batch_size': 64,
                         'hint_rate': 0.9,
                         'alpha': 100,
                         'iterations': 10000,
                         'learning_rate': 0.001}
    gain_parameters_3 = {'batch_size': 64,
                         'hint_rate': 0.9,
                         'alpha': 100,
                         'iterations': 10000,
                         'learning_rate': 0.001}
    gain_parameters_4 = {'batch_size': 64,
                         'hint_rate': 0.9,
                         'alpha': 100,
                         'iterations': 10000,
                         'learning_rate': 0.001}
    gain_parameters_5 = {'batch_size': 64,
                         'hint_rate': 0.9,
                         'alpha': 100,
                         'iterations': 10000,
                         'learning_rate': 0.001}
    ...
    for count in range(5):
        for colum in range(5):
            ...
            if colum == 0:
                gain_parameters = gain_parameters_1
            elif colum == 1:
                gain_parameters = gain_parameters_2
            elif colum == 2:
                gain_parameters = gain_parameters_3
            elif colum == 3:
                gain_parameters = gain_parameters_4
            elif colum == 4:
                gain_parameters = gain_parameters_5
            else:
                print('error')
